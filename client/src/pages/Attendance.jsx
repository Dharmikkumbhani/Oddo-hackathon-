...
const Attendance = () => {
    ...
    const getStatusForEmployee = (emp) => {
        if (user && emp.email === user.email) { // Use email for matching if IDs are tricky
    ...
    const getStatusColor = (status) => {
        switch (status) {
            ...
            case 'leave': return 'bg-blue-400'; // Airplane icon substitute color (Blue/Cyan)
            case 'absent': return 'bg-yellow-400'; // Yellow dot
                            ...
                            >
                                ...
                                <div className="p-6 flex flex-col items-center">
                                    <div className="h-20 w-20 rounded-full bg-gray-200 mb-4 overflow-hidden shadow-inner group-hover:scale-105 transition-transform duration-300">
                                        {/* Avatar Placeholder - ideally use actual image URL if available */}
